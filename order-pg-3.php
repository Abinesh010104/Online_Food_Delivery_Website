...
<body>
    ...
    <div class="order-head">
        <p>Home/India/Chennai/Kodambakkam/Ibaco/Ibaco reviews</p>
    </div>
    <div class="order-cont">
        <div class="order-div-1">
            <div class="img-m1"><img src="images/ibaco-img-1.avif"> </div>
            <div class="img-m2">
                <div class="img-m21">
                    <div class="img-m211"> <img src="images/ibaco-img-2.avif"> </div>
                    <div class="img-m212"> <img src="images/ibaco-img-3.avif"> </div>
                </div>
                <div class="img-m22">
                    <div class="img-m221"> <img src="images/ibaco-img-4.avif"> </div>
                    <div class="img-m222"><img src="images/ibaco-img-5.avif"> </div>
                </div>
            </div>
        </div>
    </div>
    <div class="main-order-content">
        <div class="order-content">
            <div class="div-1">
                <p>Ibaco</P>
                <div class="div-1-1"><span class="span"> <span class="rat-box-1">4.5<i class="fa-solid fa-star"></i></span>108 Dinning Reviews</span>
                    <span class="span"><span class="rat-box-2">4.7<i class="fa-solid fa-star"></i></span>5,757 Delivery Reviews</span>
                </div>
            </div>
            <div class="div-2">
