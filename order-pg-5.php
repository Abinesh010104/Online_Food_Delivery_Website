...
<body>
    ...
    <div class="order-head">
        <p>Home/India/Chennai/Kodambakkam/Choco dream/choco dream reviews</p>
    </div>
    <div class="order-cont">
        <div class="order-div-1">
            <div class="img-m1"><img src="images/choco-1.webp"> </div>
            <div class="img-m2">
                <div class="img-m21">
                    <div class="img-m211"> <img src="images/choco-2.webp"> </div>
                    <div class="img-m212"> <img src="images/choco-3.webp"> </div>
                </div>
                <div class="img-m22">
                    <div class="img-m221"> <img src="images/choco-4.webp"> </div>
                    <div class="img-m222"><img src="images/choco-5.webp"> </div>
                </div>
            </div>
        </div>
    </div>
    <div class="main-order-content">
        <div class="order-content">
            <div class="div-1">
                <p>Choco dream</P>
                <div class="div-1-1"><span class="span"> <span class="rat-box-1">4.4<i class="fa-solid fa-star"></i></span>108 Dinning Reviews</span>
                    <span class="span"><span class="rat-box-2">4.0 <i class="fa-solid fa-star"></i></span>5,757 Delivery Reviews</span>
                </div>
            </div>
            <div class="div-2">
